    ...
    carForm.onsubmit = function() {
        ...
        if (brandname && name && cc && years && price) {
            ...
            const newCar = {
                brandname: brandname,
                name: name,
                cc: Number(cc), // Mengonversi ke angka
                years: Number(years), // Mengonversi ke angka
                price: Number(price) // Mengonversi ke angka
            };

            // Menambahkan mobil ke daftar
            data[data.length] = newCar;

            // Mengupdate tampilan daftar mobil
            displayCars();
        ...
        return false; // Menghentikan submit form secara default
    };

    // Menampilkan daftar mobil di halaman
    function displayCars() {
        carList.innerHTML = ''; // Menghapus konten sebelumnya
