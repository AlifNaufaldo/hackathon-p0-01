...
function saveEdit() {
  ...
  document.getElementById("car" + currentCarId + "Brand").textContent =
    "Brand Name: " + brand;
  document.getElementById("car" + currentCarId + "Type").textContent =
    "Type: " + type;
  document.getElementById("car" + currentCarId + "Capacity").textContent =
    "Engine Capacity: " + capacity + "cc";
  document.getElementById("car" + currentCarId + "Year").textContent =
    "Years: " + year;
  document.getElementById("car" + currentCarId + "Price").textContent =
    "Price: Rp. " + price;
